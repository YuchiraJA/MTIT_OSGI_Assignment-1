...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {//Life cycle method-start
		System.out.println("============Welcome to Book Store. Service Started.============");
		BookSuppierService managerSer = new BookSuppierServiceImpl();
		serviceRegisterer = context.registerService(BookSuppierService.class.getName(), managerSer, null); //registering the managerService
	}
